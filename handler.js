...
text: '```🌸 Akses Bot Ke Private Chat Di Tolak, Upgrade Premium Hanya Rp 10.000 Agar Bisa Bebas Akses Bot Dengan Hubungi Owner : ```' + `@${nomorown.split("@")[0]}` + '```\n\n• Join Ke Group Official Bot Untuk Free Akses & Informasi Kedepannya Tentang Bot : https://chat.whatsapp.com/KSOWP0atWuy8439hju4d1A```',
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: true, 
title: `© Yaemiko-Wabot v3.0.3 (Public Bot)`,
thumbnailUrl: 'https://telegra.ph/file/742f0a879d4c0a5980788.jpg',
mediaType: 1,
        ...
        switch (action) {
            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
						let pp = 'https://telegra.ph/file/742f0a879d4c0a5980788.jpg'
						let ppgc = 'https://telegra.ph/file/742f0a879d4c0a5980788.jpg'
						...
						try {
                            ...
                            title: 'Dcode Rara',
                            thumbnailUrl: pp,
                            sourceUrl: 'https://chat.whatsapp.com/KSOWP0atWuy8439hju4d1A',
                            mediaType: 1,
                            renderLargerThumbnail: true
                            }}}, {quoted: null})
                        }
...
global.dfail = (type, m, conn) => {
    ...
    let imgr = 'https://telegra.ph/file/ae0b8583e5e19740c2030.jpg'
    let msg = {
